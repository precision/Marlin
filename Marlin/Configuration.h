...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 252.06
  #define  DEFAULT_bedKi 44.98
  #define  DEFAULT_bedKd 353.11
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 12, 50 }
...
#define BLTOUCH
#if ENABLED(BLTOUCH)
  #define BLTOUCH_DELAY 225   // (ms) Enable and increase if needed
#endif
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN 19 // we use Z max
